...
document.documentElement.style.setProperty("--ctp-watermark", isTauri
...
ReactDOM.createRoot(document.getElementById("root")).render(_jsx(React.StrictMode, { children: useAuthedRoot ? (_jsx(Suspense, { fallback: _jsx("div", { className: "login-wrap", children: _jsx("div", { className: "login-sub", children: "Loading\u2026" }) }), children: _jsx(AuthedApp, {}) })) : (_jsx(App, {})) }));
